...
- **Global scope**: `/Users/henry/Documents/code/vibe/hybrid/x_x/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/henry/Documents/code/vibe/hybrid/x_x/.codex/notes/`)
...
2. Glob `/Users/henry/Documents/code/vibe/hybrid/x_x/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/henry/Documents/code/vibe/hybrid/x_x/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/henry/Documents/code/vibe/hybrid/x_x/.codex/notes/` — works in any directory
